...
def main():
    ...
    for i in range(0, len(fonts)):
        name_font = fonts[i][fonts[i].rfind("/")+1:].replace(".ttf", "").replace(".otf", "")
        path_folder = os.path.join(args.output_dir, os.path.join(args.language, name_font))
        print(path_folder)
        ...
        for _ in tqdm(
                p.imap_unordered(
                    ...
                    zip(
                        ...
                        strings,
                        [fonts[i] for _ in range(0, string_count)],
                        [path_folder] * string_count,
                        ...
                        ['#%02X%02X%02X' % (r(), r(), r()) for i in range(0, string_count)],
